...
const ReceiveFromPostman = () => {
    ...
    const fetchRcvBills = async () => {
        const rcv = await billService.rcvFromPostman(axiosConfig);
        setRcvBills(rcv);
    }
    ...
    return(
        <div className='db-content'>
            <h3>Receive shipment from Postman:</h3>
            <hr/>
            <Row>
                                ...
                                {rcvBills.length !== 0 ? (
                                    rcvBills.map((bill, index) => (
                                        <tr onClick={() => setBillDetails(bill)} key={index}>
                                            ...
                                            <td>Receive from Shipper at {moment(bill.latestStatus.time).format('DD/MM/YYYY HH:mm:ss')}</td>
                                        </tr>
                                    ))
                                ) : (
                            ...
                            <div>
                                <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
                                    ...
                                    <div className={"text-center"}>
                                        {billDetails.latestStatus.typeId === 2 ? (
...
export default ReceiveFromPostman;