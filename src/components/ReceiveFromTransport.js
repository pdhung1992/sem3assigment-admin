...
const ReceiveFromTransport = () => {
    ...
    const fetchRcvFromTrans = async () => {
        const rcv = await billService.receiveFromTransport(axiosConfig);
        setRcvBills(rcv);
    }
    ...
    return(
        <div className='db-content'>
            <h3>Receive shipments from Transport:</h3>
            <hr/>
            <Row>
                            ...
                            <div>
                                <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
                                    ...
                                    <div className={"text-center"}>
                                        {billDetails.latestStatus.typeId === 4 ? (
...
export default ReceiveFromTransport;