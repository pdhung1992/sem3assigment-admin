...
const ReceiveFromPostOffice = () => {
    ...
    const fetchRcvFromPO = async () => {
        const rcv = await billService.receiveFromPostOffice(axiosConfig);
        setRcvBills(rcv);
    }
    ...
    return(
        <div className='db-content'>
            <h3>Receive shipments from Post Office:</h3>
            <hr/>
            <Row>
                            ...
                            <div>
                                <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
                                    ...
                                    <div className={"text-center"}>
                                        {billDetails.latestStatus.typeId === 5 ? (
...
export default ReceiveFromPostOffice;